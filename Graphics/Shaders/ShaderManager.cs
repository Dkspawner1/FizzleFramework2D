            ...
            try
            {
                ...
                unsafe
                {
                    var pipelineInfo = new SDLGPUGraphicsPipelineCreateInfo
                    {
                        ...
                        PrimitiveType = SDLGPUPrimitiveType.Trianglelist, // Fixed: Use correct enum value
                        ...
                        {
                            SampleCount = SDLGPUSampleCount.Samplecount1, // Fixed: Use correct enum value
                            SampleMask = 0xFFFFFFFF
                        },
                        // Add more pipeline state as needed
                    };
                    ...
                    {
                        var error = GetError()->ToString();
                        throw new ShaderLinkException($"Failed to create graphics pipeline '{programName}': {error}"); // Fixed: Use correct exception type
                    }
